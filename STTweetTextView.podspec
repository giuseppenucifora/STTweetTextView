#
# Be sure to run `pod lib lint STTweetTextView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = "STTweetTextView"
  s.version          = "0.1.0"
  s.summary          = "A short description of STTweetTextView."
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.resource_bundles = {
    'STTweetTextView' => ['Pod/Assets/*.png']
  }
